...
sudo dnf install @base-x gnome-shell gnome-terminal nautilus util-linux-user sqlite wget vim samba-client gvfs-smb zsh -y
...
sudo dnf install firefox flatpak gnome-terminal-nautilus xdg-user-dirs xdg-user-dirs-gtk ffmpegthumbnailer gnome-system-monitor zsh htop tldr neofetch ulauncher gnome-tweaks gnome-menus-devel -y
